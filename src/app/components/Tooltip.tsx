const Tooltip = ({
  ...
  return (
    <span className={`inline-flex group relative max-w-max flex-col items-center justify-center ${className}`}>
      ...
      <span className="absolute left-1/2 top-7 ml-auto mr-auto min-w-max -translate-x-1/2 opacity-0 transform rounded-lg px-3 py-2 text-xs font-medium transition-opacity duration-300 group-hover:opacity-100 origin-top pointer-events-none">
        <span className="flex max-w-xs flex-col items-center shadow-lg">
          <span className="clip-bottom h-2 w-4 bg-gray-800 mb-[-1px]"></span>
